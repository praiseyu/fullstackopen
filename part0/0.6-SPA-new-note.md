...
sequenceDiagram
    ...
    Note right of browser: instead of telling the browser to send a GET request to obtain the updated notes, the JavaScript code handles the re-rendering on the front end
```
